...
export declare const sessionManager: {
    ...
    setVerificationCode(email: string, code: string, expiresIn?: number): Promise<void>;
    getVerificationCode(email: string): Promise<string | null>;
    deleteVerificationCode(email: string): Promise<void>;
};
export declare const getConfig: () => import("./config-loader").DatabaseConfig;
export declare const reloadConfig: () => import("./config-loader").DatabaseConfig;
...
declare const _default: {
    ...
    getConfig: () => import("./config-loader").DatabaseConfig;
    reloadConfig: () => import("./config-loader").DatabaseConfig;
